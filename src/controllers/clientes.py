...
@server.app.get('/Cliente')
# HTTP_200=Secoes
@server.api.validate(resp=Response(HTTP_200=Clientes), tags=['Clientes'])
def Get():
    """
...
@server.app.post('/Cliente')
# HTTP_200=jsonify,
@server.api.validate(body=Request(Cliente), resp=Response(HTTP_400=Erro,  HTTP_500=Erro), tags=['Clientes'])
def Post():
    """
...
@server.app.post('/BuscarClientes')
# HTTP_200=Secoes
@server.api.validate(body=Request(Cliente), resp=Response(HTTP_200=Clientes), tags=['Clientes'])
def BuscarCliente():
    """
